                      ...
                      children: [
                          ...
                          child: Column(
                            ...
                            children: [
                              Row(
                                mainAxisAlignment: MainAxisAlignment.center,
                                children: [
                                  Image.asset(AppImages.wallet, width: 21.w, height: 17.h,),
                                  SizedBox(width: 7.w,),
                                  Text("Balance", style: GoogleFonts.inter(
                                    fontSize: 14.sp,
                              ...
                              Text("79.00 AED", style: GoogleFonts.inter(
                                  fontSize: 20.sp,
                                  color: AppColors.primary,
                        ...
                        Expanded(
                          child: Column(
                            ...
                            crossAxisAlignment: CrossAxisAlignment.center,
                            children: [
                              Text("Availability ", style: GoogleFonts.inter(
                                  fontSize: 14.sp,
                                  color: AppColors.primary,
                                  fontWeight: FontWeight.w600
                              ),
                              ...
                              SizedBox(
                                height: 30,
                                child: Obx(
                                  ()=> Switch(value: userVM.availability.value, onChanged: (val){
                                    userVM.availability.value = val;
                                    },
                                    activeColor: AppColors.switchGreen,
                                    activeTrackColor: AppColors.switchGreen.withOpacity(.30),
                          ...
                          Row(
                            ...
                            children: [
                              Container(
                                ...
                                alignment: Alignment.center,
                                child: Text("New", style: montserrat600(11.sp, AppColors.primary),),
                              ),
                              Container(
                                height: 21.h,
                                width: 108.w,
                                ...
                                alignment: Alignment.center,
                                child: Text("Plumbing", style: montserrat600(11.sp, AppColors.primary),),
                              ),
                            ],
                          ),
                                    ...
                                    children: [
                                      Row(
                                        ...
                                        children: [
                                          ...
                                          Text("ID #2145", style: jost600(12.sp, AppColors.secondary),),
                                        ],
                                      ),
                                      SizedBox(height: 6.h,),
                                      Row(
