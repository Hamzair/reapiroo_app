          ...
          child: Column(
            ...
            children: [
              ...
              DropdownButtonFormField<String>(
                value: selectedBank,
                hint: Text("Bank Name", style: jost400(14.65.sp, AppColors.primary)),
                decoration: InputDecoration(
                  filled: true,
                  fillColor: AppColors.secondary,
                  contentPadding: EdgeInsets.symmetric(vertical: 10.h, horizontal: 12.w),
                  border: OutlineInputBorder(borderRadius: BorderRadius.circular(13.0.r)),
                ),
              ...
              CustomInputField(controller: name, hintText: "Full Name", contentPadding: EdgeInsets.symmetric(vertical: 10.h, horizontal: 12.w)),
              SizedBox(height: 11.h),
              CustomInputField(controller: iban, hintText: "IBAN", contentPadding: EdgeInsets.symmetric(vertical: 10.h, horizontal: 12.w)),
              SizedBox(height: 11.h),
              CustomInputField(controller: accNumber, hintText: "Account Number", contentPadding: EdgeInsets.symmetric(vertical: 10.h, horizontal: 12.w)),
              SizedBox(height: 26.h),
              GestureDetector(
                onTap: () {
                  _addBankAccount();
                  Get.to(WalletDetail(
                    ...
                    bankImage: banks.firstWhere((bank) => bank['name'] == selectedBank, orElse: () => {'image': 'assets/images/bank.png'})['image']!,
                ...
                child: Container(
                  ...
                  child: Center(
                    child: Text("Add", style: jost600(19.sp, AppColors.primary)),
                  ),
                ),
              ),
            ],
